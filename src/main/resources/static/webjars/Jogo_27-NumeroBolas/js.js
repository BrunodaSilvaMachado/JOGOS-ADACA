...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 30, 77, 132, 66, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 30, 327, 132, 66, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 30, 577, 132, 66, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
        ...
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top - 5))
                }, vet[i][7]);
            }
        },
        stop: function() {
...
//imagem 3
 ...
 //substituir daqui
    ...
    function ajaxSave() {
        ...
        var idAtividade = 27;    //alterar esse id para o número do jogo
