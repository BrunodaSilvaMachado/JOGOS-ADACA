...
$(document).ready(function() {
    ...
    var finalizado = 0;
    var numObjtos = 2;    //quantidade de figuras (palavras com duas silabas)
    var numTotal = 7;    //7 silabas
    var numAnimais = 4;
    ...
    //separa a palavra animal em silaba
    silaba = new Array(2);
    silaba[0] = (animal[0]+animal[1]);
    silaba[1] = (animal[2]+animal[3]);

    //aqui vem as silabas que não são usadas na palavra    
    letras = new Array(numTotal - numObjtos);
    var iletras = 0;
    if ("PA" != (animal[0]+animal[1]) && "PA" != (animal[0]+animal[1])){
        letras[iletras] = "PA";
        iletras = iletras + 1;
    }
    if ("TO" != (animal[0]+animal[1]) && "TO" != (animal[2] +animal[3])){
        letras[iletras] = "TO";
        iletras = iletras + 1;
    }
    if ("GA" != (animal[0]+animal[1]) && "GA" != (animal[2] +animal[3])){
        letras[iletras] = "GA";
        iletras = iletras + 1;
    }
    if ("FO" != (animal[0]+animal[1]) && "FO" != (animal[2] +animal[3])){
        letras[iletras] = "FO";
        iletras = iletras + 1;
    }
    if ("CA" != (animal[0]+animal[1]) && "CA" != (animal[2] +animal[3])){
        letras[iletras] = "CA";
        iletras = iletras + 1;
    }
    if ("SA" != (animal[0]+animal[1]) && "SA" != (animal[2] +animal[3])){
        letras[iletras] = "SA";
        iletras = iletras + 1;
    }
    if ("PO" != (animal[0]+animal[1]) && "PO" != (animal[2] +animal[3])){
        letras[iletras] = "PO";
        iletras = iletras + 1;
    }
    ...
    vet = new Array(
        new Array($("#"+silaba[0]), 80, 200, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+1)),
        new Array($("#"+silaba[1]), 240, 200, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#"+letras[0]), 10, 350, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#"+letras[1]), 160, 350, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#"+letras[2]), 320, 350, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+5)),
        new Array($("#"+letras[3]), 10, 460, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+6)),
        new Array($("#"+letras[4]), 160, 460, 150, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+7))
    );
    ...
    vet[leexc][0].css({left: 320, top: 460});
    vet[leexc][1] = 320;
    vet[leexc][2] = 460;
    ...
    $("#caixa1").css({left: vet[anexc][1]+5, top: vet[anexc][2]});
    $("#caixa2").css({left: vet[2][1]+5, top: vet[2][2]});
    $("#caixa3").css({left: vet[3][1]+5, top: vet[3][2]});
    $("#caixa4").css({left: vet[4][1]+5, top: vet[4][2]});
    $("#caixa5").css({left: vet[5][1]+5, top: vet[5][2]});
    $("#caixa6").css({left: vet[6][1]+5, top: vet[6][2]});
    //$("#caixa7").css({left: vet[6][1], top: vet[6][2]});
    //$("#caixa8").css({left: vet[7][1], top: vet[7][2]});
    ...
    function endgame() {
        ...
        delay(function(){
            ...
            if (vet[anexc][5] == 2) {           // Se as três imagens já estiverem nos alvos, dipara
