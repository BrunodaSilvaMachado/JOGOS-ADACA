...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        ...
        new Array($("#img"+4), 191, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#img"+5), 352, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+5))
    );
...
//imagem 5
    ...
    function ajaxSave() {
        ...
        var idAtividade = 31;    //alterar esse id para o número do jogo
