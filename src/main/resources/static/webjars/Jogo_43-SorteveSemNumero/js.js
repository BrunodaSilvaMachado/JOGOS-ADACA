...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+1), 431, 60, 144, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+1)),
        new Array($("#img"+2), 60, 60, 144, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#img"+3), 616, 60, 144, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#img"+4), 245, 60, 144, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+4))
    );
...
//imagem 1
    vet[0][0].draggable({
        ...
        stop: function() {
            i=0;
            mouseDrag += mousex+","+mousey+")";
            if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4] + 100)){
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].offset().left, top: (vet[i][9].offset().top + 50)});
                vet[i][5] = 2;
    ...
    vet[1][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    if(vet[0][5] == 2){   //indice da imagem 2
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top + 60));
                    }
        ...
        stop: function() {
            i=1;
            mouseDrag += mousex+","+mousey+")";
            if (vet[0][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4] + 100)){
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top +50, zIndex: 0});
				vet[i][5] = 2;
                vet[i][0].draggable('disable');
                cliqueCerto++;
                endgame();
...
//imagem 3
    vet[2][0].draggable({
        ...
        stop: function() {
            i=2;
            mouseDrag += mousex+","+mousey+")";
            if (vet[1][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4] + 100)){
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top + 50, zIndex: 0});
				vet[i][5] = 2;
                vet[i][0].draggable('disable');
...
//imagem 4
    vet[3][0].draggable({
        ...
        stop: function() {
            i=3;
            mouseDrag += mousex+","+mousey+")";
            if (vet[2][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4] + 100)){
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top + 50, zIndex: 0});
				vet[i][5] = 2;
                vet[i][0].draggable('disable');
    ...
    vet[0][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4]+100)) {
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top + 50, zIndex: 0});
				vet[i][5] = 2;
    ...
    vet[1][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (vet[0][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4]+100)) {
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top + 50, zIndex: 0});
				vet[i][5] = 2;
				vet[i][9].css({opacity: 0.1});
    ...
    vet[2][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (vet[1][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4]+100)) {
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top + 50, zIndex: 0});
				vet[i][5] = 2;
				vet[i][9].css({opacity: 0.1});
...
//imagem 4
    vet[3][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (vet[2][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4]+100)) {
				$("#container").append(vet[i][0]);
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top + 50, zIndex: 0});
				vet[i][5] = 2;
				vet[i][9].css({opacity: 0.1});
    ...
    function ajaxSave() {
        ...
        var idAtividade = 43;    //alterar esse id para o número do jogo
