...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 30, 415, 340, 120, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 30, 292, 340, 120, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 30, 168, 340, 120, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
//imagem 3
    ...
    function mostraDicaPisca(i){
        ...
        if(vet[i][9].offset().top < 180)
        {
            $("#dicaPisca1").fadeIn(500);
            $("#dicaPisca1").fadeOut(500);
        }
        if(vet[i][9].offset().top > 200 && vet[i][9].offset().top < 400)
        {
    ...
    function ajaxSave() {
        ...
        var idAtividade = 24;    //alterar esse id para o número do jogo
