...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        ...
        new Array($("#img"+sort2), 65, 281, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 65, 450, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
//imagem 3
    ...
    function ajaxSave() {
        ...
        var idAtividade = 18;    //alterar esse id para o número do jogo
