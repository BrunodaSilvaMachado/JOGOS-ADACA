...
//imagem 1
    vet[0][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                vet[i][5] = 1;
                //vet[i][0].css({left: validXPosition(vet[i][3]), top: validYPosition(vet[i][4]), zIndex: 2});    
        ...
        stop: function() {
            ...
            if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
                ...
                vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top, zIndex: 0});
				vet[i][5] = 2;
            ...
            {
                vet[i][0].animate({left: vet[i][1], top: vet[i][2], zIndex: 0}, 500);
                vet[i][5] = 0;
            }
            removeDica();
        },
    ...
    vet[0][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                vet[i][0].css({left: vet[i][1], top: vet[i][2], zIndex: 0});
                vet[i][5] = 0;
...
function animaEstrela(){
    ...
    function ajaxSave() {
        ...
        var idAtividade = 47;    //alterar esse id para o número do jogo
