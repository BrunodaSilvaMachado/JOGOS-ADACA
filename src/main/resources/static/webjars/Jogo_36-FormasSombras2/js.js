...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 50, 40, 200, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 50, 270, 200, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 50, 501, 200, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
//imagem 3
    ...
    function ajaxSave() {
        ...
        var idAtividade = 36;    //alterar esse id para o número do jogo
