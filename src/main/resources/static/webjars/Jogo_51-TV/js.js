...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+1), 20, 30, 130, 121, 0, tipodeDica, tempodeDica, 0, $("#fundo2")),
        new Array($("#img"+2), 150, 30, 130, 121, 0, tipodeDica, tempodeDica, 0, $("#fundo1")),
        new Array($("#img"+3), 280, 30, 130, 121, 0, tipodeDica, tempodeDica, 0, $("#fundo2")),
        new Array($("#img"+4), 410, 30, 130, 121, 0, tipodeDica, tempodeDica, 0, $("#fundo1")),
        new Array($("#img"+5), 540, 30, 130, 121, 0, tipodeDica, tempodeDica, 0, $("#fundo2")),
        new Array($("#img"+6), 670, 30, 130, 121, 0, tipodeDica, tempodeDica, 0, $("#fundo1"))
    );
...
//imagem 6
    ...
    function ajaxSave() {
        ...
        var idAtividade = 51;    //alterar esse id para o número do jogo
