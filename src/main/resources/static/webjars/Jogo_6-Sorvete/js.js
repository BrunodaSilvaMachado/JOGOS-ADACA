...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img1"), 30, 375, 165, 165, 0, tipodeDica, tempodeDica, 0, $("#target1")),
        new Array($("#img2"), 170, 480, 165, 165, 0, tipodeDica, tempodeDica, 0, $("#target2")),
        new Array($("#img3"), 10, 550, 165, 165, 0, tipodeDica, tempodeDica, 0, $("#target3")),
        new Array($("#img4"), 30, 12, 195, 335, 0, tipodeDica, tempodeDica, 0, $("#target4"))
    );
    ...
    if (sort1 == 1 && sort2 ==3) {
        ...
        aux1 = vet[1][1];
        aux2 = vet[2][1]
        vet[1][0].css({left: aux1});
        vet[2][0].css({left: aux2});
    } else if (sort1==3 && sort2==1) {
        aux1=0;
        aux2=0;
        aux1 = vet[1][1];
        vet[0][0].css({left: vet[0][1]});
        aux2 = vet[2][1];
        vet[1][0].css({left: aux1});
        vet[2][0].css({left: aux2});
    } else if (sort3== 3 && sort2==1){
        aux = vet[0][1];
        vet[1][0].css({left: vet[1][1]});
        vet[0][0].css({left: vet[0][1]});
    } else if( sort2 == 2 && sort3 == 1){
        vet[0][0].css({left: vet[0][1]});
        vet[2][0].css({left: vet[2][1]});   
    } else if (sort1== 2 && sort2 == 3) {
        vet[2][0].css({left: vet[2][1]});
        vet[0][0].css({left: vet[0][1]});
        vet[1][0].css({left: vet[1][1]});
    }
...
//FadeIn e FadeOut das imagens
    $("#dicaPisca1_M1").fadeOut(0);
    $("#dicaPisca1_M2").fadeOut(0);
    $("#dicaPisca1_M3").fadeOut(0);
    $("#dicaPisca2_A1").fadeOut(0);
    $("#dicaPisca2_A2").fadeOut(0);
    $("#dicaPisca2_A3").fadeOut(0);
    $("#dicaPisca3_R1").fadeOut(0);
    $("#dicaPisca3_R2").fadeOut(0);
    $("#dicaPisca3_R3").fadeOut(0);
    $("#dicaPisca4").fadeOut(0);
    var i;
...
//imagem 1
    vet[0][0].draggable({
        start: function() {
            //target1Ocupado = false;
            //target2Ocupado = false;
            //target3Ocupado = false;
            i=0;
            if (vet[i][5] == 0){
                vet[i][5] = 1;
                ...
                dicaTimeout = setTimeout(function() {
                    if(target1Ocupado == false)
                    {
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left -100), (vet[i][9].offset().top + 50))
                    }else if(target2Ocupado == false)
                    {
                        mostraDica(i, vet[i][6], (vet[i+1][9].offset().left - 100), (vet[i+1][9].offset().top + 50))
                    }else
                    {
                        mostraDica(i, vet[i][6], (vet[i+2][9].offset().left - 100), (vet[i+2][9].offset().top + 50))
                    }
                }, vet[i][7]);
            }
        },
        stop: function() {
            ...
            {
                if(target1Ocupado == false)                                         //Testa se o local que ela vai ocupar, já tem uma imagem lá. 
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i][9].offset().left, top: vet[i][9].offset().top}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela
                    target1Ocupado = true;
                    cliqueCerto++;
                    endgame();
                }
                ...
                {
                    vet[i][0].animate({left: vet[i][1], top: vet[i][2]}, 500);                     //Aqui a Imagem volta para posição inicial do jogo
                    vet[i][5] = 0;
                }
            }else
            if (mousex > vet[i+1][9].offset().left && mousex < (vet[i+1][9].offset().left + vet[i][3]) && mousey > vet[i+1][9].offset().top && mousey < (vet[i+1][9].offset().top + vet[i][4])) 
            {
                if(target2Ocupado == false)
                {
                    vet[i][0].css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela   
                    target2Ocupado = true;
                    endgame();
            ...
            if (mousex > vet[i+2][9].offset().left && mousex < (vet[i+2][9].offset().left + vet[i][3]) && mousey > vet[i+2][9].offset().top && mousey < (vet[i+2][9].offset().top + vet[i][4])) 
            {
                if(target3Ocupado == false)
                {
                    vet[i][0].css({left: vet[i+2][9].offset().left, top: vet[i+2][9].offset().top}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela
                    target3Ocupado = true;
                    endgame();    
                ...
                vet[i][0].animate({left: vet[i][1], top: vet[i][2]}, 500);                                     // se não, move ela para a posição inicial com animação
                vet[i][5] = 0;                                                             // retorna seu state para 0
            }
            removeDica();
        },
    ...
    vet[3][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top + 100))
                }, vet[i][7]);
            }
        },
        stop: function() {
        ...
        if (vet[i][5] == 0){
            ...
            } else if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])) 
            {
                ...
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i][9].offset().left, top: vet[i][9].offset().top}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;
                    clearInterval(vet[i][8]);                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela
                    target1Ocupado = true;
                    cliqueCerto++;
                    mouseClique += mousex+","+mousey+");";
                ...
                {
                    vet[i][0].animate({left: 150, top: 12}, 500);                    //Aqui a Imagem volta para posição inicial do jogo
                    vet[i][5] = 0;
                }
            }else
            if (mousex > vet[i+1][9].offset().left && mousex < (vet[i+1][9].offset().left + vet[i][3]) && mousey > vet[i+1][9].offset().top && mousey < (vet[i+1][9].offset().top + vet[i][4])) 
            {
                ...
                {
                    vet[i][0].animate({left: 150, top: 12}, 500);
                    vet[i][5] = 0;
                }
            }else 
            if (mousex > vet[i+2][9].offset().left && mousex < (vet[i+2][9].offset().left + vet[i][3]) && mousey > vet[i+2][9].offset().top && mousey < (vet[i+2][9].offset().top + vet[i][4])) 
            ...
            {
                vet[i][0].animate({left: 150, top: 12}, 500);                                    // se não, move ela para a posição inicial com animação
                vet[i][5] = 0;                                                             // retorna seu state para 0
            }
            removeDica();
    ...
    vet[1][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (mousex > vet[i-1][9].offset().left && mousex < (vet[i-1][9].offset().left + vet[i][3]) && mousey > vet[i-1][9].offset().top && mousey < (vet[i-1][9].offset().top + vet[i][4])) 
            {
                if(target1Ocupado == false)                                         //Testa se o local que ela vai ocupar, já tem uma imagem lá. 
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                ...
                {
                    vet[i][0].animate({left: 150, top: 140}, 500);                    //Aqui a Imagem volta para posição inicial do jogo
                    vet[i][5] = 0;
                }
            }else
            if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])) 
            {
                ...
                {
                    vet[i][0].animate({left: 150, top: 140}, 500);
                    vet[i][5] = 0;
                }
            }else 
            if (mousex > vet[i+1][9].offset().left && mousex < (vet[i+1][9].offset().left + vet[i][3]) && mousey > vet[i+1][9].offset().top && mousey < (vet[i+1][9].offset().top + vet[i][4])) 
            ...
            {
                vet[i][0].animate({left: 150, top: 140}, 500);                                    // se não, move ela para a posição inicial com animação
                vet[i][5] = 0;                                                             // retorna seu state para 0
            }
            removeDica();
                //vet[i][0].css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
    ...
    vet[2][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (mousex > vet[i-2][9].offset().left && mousex < (vet[i-2][9].offset().left + vet[i][3]) && mousey > vet[i-2][9].offset().top && mousey < (vet[i-2][9].offset().top + vet[i][4])) 
            {
                if(target1Ocupado == false)                                         //Testa se o local que ela vai ocupar, já tem uma imagem lá. 
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i-2][9].offset().left, top: vet[i-2][9].offset().top}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
...
//imagem 4
    ...
    function mostraDicaPisca(i){
        if(i==0){
            $("#dicaPisca1_M1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca1_M2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
            $("#dicaPisca1_M3").css({left: vet[i+2][9].offset().left, top: vet[i+2][9].offset().top});
            $("#dicaPisca2_A1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca2_A2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
            $("#dicaPisca2_A3").css({left: vet[i+2][9].offset().left, top: vet[i+2][9].offset().top});
            $("#dicaPisca3_R1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca3_R2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
            $("#dicaPisca3_R3").css({left: vet[i+2][9].offset().left, top: vet[i+2][9].offset().top});
        }
        if(i==1)
        {
            $("#dicaPisca1_M1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca1_M2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca1_M3").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
            $("#dicaPisca2_A1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca2_A2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca2_A3").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
            $("#dicaPisca3_R1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca3_R2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca3_R3").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
        }
        if(i==2)
        {
            $("#dicaPisca1_M1").css({left: vet[i-2][9].offset().left, top: vet[i-2][9].offset().top});
            $("#dicaPisca1_M2").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca1_M3").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca2_A1").css({left: vet[i-2][9].offset().left, top: vet[i-2][9].offset().top});
            $("#dicaPisca2_A2").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca2_A3").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca3_R1").css({left: vet[i-2][9].offset().left, top: vet[i-2][9].offset().top});
            $("#dicaPisca3_R2").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca3_R3").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
        }
        $("#dicaPisca4").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});

        if(vet[i][9].offset().top > 300) //seria pras três maças
        {
            $("#dicaPisca4").fadeIn(500);
            $("#dicaPisca4").fadeOut(500);
        }else
        {
            if(i==0){  // é a imagem amarela
                if(target1Ocupado == false && target2Ocupado == false && target3Ocupado == false){
                    $("#dicaPisca2_A1").fadeIn(500);
                    $("#dicaPisca2_A1").fadeOut(500);
                    $("#dicaPisca2_A2").fadeIn(500);
                    $("#dicaPisca2_A2").fadeOut(500);
                    $("#dicaPisca2_A3").fadeIn(500);
                    $("#dicaPisca2_A3").fadeOut(500);
                }else{
                    if(target1Ocupado == true && target2Ocupado == false && target3Ocupado == false){
                        $("#dicaPisca2_A2").fadeIn(500);
                        $("#dicaPisca2_A2").fadeOut(500);
                        $("#dicaPisca2_A3").fadeIn(500);
                        $("#dicaPisca2_A3").fadeOut(500);
                    }
                    if(target2Ocupado == true && target1Ocupado == false && target3Ocupado == false){
                        $("#dicaPisca2_A1").fadeIn(500);
                        $("#dicaPisca2_A1").fadeOut(500);
                        $("#dicaPisca2_A3").fadeIn(500);
                        $("#dicaPisca2_A3").fadeOut(500);
                    }
                    if(target3Ocupado == true && target2Ocupado == false && target1Ocupado == false){
                        $("#dicaPisca2_A1").fadeIn(500);
                        $("#dicaPisca2_A1").fadeOut(500);
                        $("#dicaPisca2_A2").fadeIn(500);
                        $("#dicaPisca2_A2").fadeOut(500);
                    }
                    if(target1Ocupado == true && target2Ocupado == true && target3Ocupado == false){
                        $("#dicaPisca2_A1").fadeIn(500);
                        $("#dicaPisca2_A1").fadeOut(500);
                    }
                    if(target2Ocupado == true && target3Ocupado == true && target1Ocupado == false){
                        $("#dicaPisca1_A1").fadeIn(500);
                        $("#dicaPisca1_A1").fadeOut(500);
                    }
                    if(target1Ocupado == true && target3Ocupado == true && target2Ocupado == false){
                        $("#dicaPisca2_A2").fadeIn(500);
                        $("#dicaPisca2_A2").fadeOut(500);
                    }
                }
            }
            if(i==1){  // é a imagem rosa
                if(target1Ocupado == false && target2Ocupado == false && target3Ocupado == false){
                    $("#dicaPisca3_R1").fadeIn(500);
                    $("#dicaPisca3_R1").fadeOut(500);
                    $("#dicaPisca3_R2").fadeIn(500);
                    $("#dicaPisca3_R2").fadeOut(500);
                    $("#dicaPisca3_R3").fadeIn(500);
                    $("#dicaPisca3_R3").fadeOut(500);
                }else{
                    if(target1Ocupado == true && target2Ocupado == false && target3Ocupado == false){
                        $("#dicaPisca3_R2").fadeIn(500);
                        $("#dicaPisca3_R2").fadeOut(500);
            ...
            if(i==2){  // é a imagem marrom
                if(target1Ocupado == false && target2Ocupado == false && target3Ocupado == false)
                {
                    $("#dicaPisca1_M1").fadeIn(500);
                    $("#dicaPisca1_M1").fadeOut(500);
                    $("#dicaPisca1_M2").fadeIn(500);
                    $("#dicaPisca1_M2").fadeOut(500);
                    $("#dicaPisca1_M3").fadeIn(500);
                    $("#dicaPisca1_M3").fadeOut(500);
                }else{
                    if(target1Ocupado == true && target2Ocupado == false && target3Ocupado == false)
                    {
                        $("#dicaPisca1_M2").fadeIn(500);
    ...
    function ajaxSave() {
        ...
        var idAtividade = 6;    //alterar esse id para o número do jogo
