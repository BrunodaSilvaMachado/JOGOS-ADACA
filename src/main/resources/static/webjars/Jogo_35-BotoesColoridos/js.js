...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        ...
        new Array($("#img"+2), 250, 20, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#img"+3), 130, 160, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#img"+4), 20, 310, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#img"+5), 250, 310, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+5)),
        new Array($("#img"+6), 130, 450, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+6)),
        new Array($("#img"+7), 20, 600, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+7)),
        new Array($("#img"+8), 250, 600, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+8))
    );
...
//imagem 8
    ...
    function ajaxSave() {
        ...
        var idAtividade = 35;    //alterar esse id para o número do jogo
