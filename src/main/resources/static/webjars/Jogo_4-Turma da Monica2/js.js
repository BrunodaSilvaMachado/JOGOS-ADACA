...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 60, 111, 175, 175, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 60, 300, 175, 175, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 60, 486, 175, 175, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
//imagem 3
    ...
    function ajaxSave() {
        ...
        var idAtividade = 4;    //alterar esse id para o número do jogo
