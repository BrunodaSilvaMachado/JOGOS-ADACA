...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+1), 115, 258, 72, 72, 0, tipodeDica, tempodeDica, 0, $("#target"+1)),
        new Array($("#img"+2), 70, 360, 72, 71, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#img"+3), 150, 360, 72, 72, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#img"+4), 70, 465, 72, 72, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#img"+5), 150, 465, 72, 71, 0, tipodeDica, tempodeDica, 0, $("#target"+5))
    );
        ...
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left +5 ), (vet[i][9].offset().top - vet[i][4]));
                }, vet[i][7]);
            }
        },
        stop: function() {
...
//imagem 2
    vet[1][0].draggable({
        ...
        stop: function() {
            i=1;
            mouseDrag += mousex+","+mousey+")";
            if (vet[0][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
                vet[i][0].draggable('disable');
...
//imagem 3
    vet[2][0].draggable({
        ...
        stop: function() {
            i=2;
            mouseDrag += mousex+","+mousey+")";
            if (vet[0][5] == 2 && vet[1][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
                vet[i][0].draggable('disable');
    ...
    vet[3][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                cliqueCerto++;
                mouseDrag += "("+mousex+","+mousey+";";
               if(vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2){
                    dicaTimeout = setTimeout(function() {
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left +5 ), (vet[i][9].offset().top - vet[i][4]));
                    }, vet[i][7]);
                }
        ...
        stop: function() {
            i=3;
            mouseDrag += mousex+","+mousey+")";
            if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
                vet[i][0].draggable('disable');
...
//imagem 5
    vet[4][0].draggable({
        ...
        stop: function() {
            i=4;
            mouseDrag += mousex+","+mousey+")";
            if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && vet[3][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
                vet[i][0].draggable('disable');
    ...
    vet[2][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (vet[0][5] == 2 && vet[1][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
				vet[i][9].css({opacity: 0.1});
    ...
    vet[3][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
				vet[i][9].css({opacity: 0.1});
    ...
    vet[4][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                mouseClique += mousex+","+mousey+");";
                removeDica();
            } else if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && vet[3][5] == 2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top});
                vet[i][5] = 2;
				vet[i][9].css({opacity: 0.1});
...
//----------------
    ...
    function mostraDicaPisca(i){
        ...
        */
        ...
        {
            var j = i+1;
            $("#dicaPisca"+j).animate({opacity: '1.0'}, "slow");
            $("#dicaPisca"+j).animate({opacity: '0.0'}, "slow");
        }
    ...
    function ajaxSave() {
        ...
        var idAtividade = 56;    //alterar esse id para o número do jogo
