...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 70, 91, 188, 112, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 70, 550, 145, 152, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 100, 300, 98, 173, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
        ...
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top + 0))
                }, vet[i][7]);
            }
        },
        stop: function() {
...
function animaEstrela(){
    ...
    function disableselect(e){   
     ...
     function ajaxSave() {
        ...
        var idAtividade = 26;    //alterar esse id para o número do jogo
