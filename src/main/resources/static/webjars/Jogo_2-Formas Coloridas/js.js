...
while( sort2 == sort1 || sort3 == sort1 || sort3 == sort2) {
    ...
    var comemoracaoSonora = getQueryVariable("campoEscondidoMusicaFundo");                     // retorn 0-Mudo, 1-ComemoracaoAleatoria
    //var dicasonora = "CombineAsFiguras";//vai ser um getQueryVariable(""); recebendo um campo escondido
    
    //console.log("Tipo dica: "+tipodeDica);
...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    //vet = new Array(3,8,9);
    vet = new Array(
        new Array($("#img"+sort1), 70, 91, 170, 170, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 70, 270, 170, 170, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 70, 452, 170, 170, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
//FadeIn e FadeOut das imagens
    ...
    var k = 500;
    for(i = 0; i<numObjtos; i++) {
        vet[i][0].fadeIn(k);        // Traz as imagens
        k+= 500;
    }
    fundo.fadeIn(2000);
...
//Definindo funções
    ...
    if(tipoSom == 1){   //palmas
		...
		//sound.setAttribute('src', '../../audio/audio.ogg');
		sound = new AudioController(  '/audio/audio.mp3');
    }
    else if(tipoSom == 2){  //plimplimplim
        //sound = new AudioController(  '/audio/plim.mp3');
		//sound.setAttribute('src', '../../audio/plim.ogg');
		sound = new AudioController(  '/audio/plim.mp3');
    }
    else if(tipoSom == 3){
		//sound.setAttribute('src', '../../audio/somfogos.ogg');
...
//imagem 1
    vet[0][0].draggable({     //$("#img1").draggable
        start: function() {
            i=0;
            if (vet[i][5] == 0){
                vet[i][5] = 1;
...
//imagem 3
    ...
    function ajaxSave() {
        ...
        var idAtividade = 2;    //alterar esse id para o número do jogo
