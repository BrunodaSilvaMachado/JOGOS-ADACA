...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 65, 110, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 65, 295, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 65, 483, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
//imagem 3
    ...
    function ajaxSave() {
        ...
        var idAtividade = 21;    //alterar esse id para o número do jogo
