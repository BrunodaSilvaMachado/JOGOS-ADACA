...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img1"), 30, 32, 400, 140, 0, tipodeDica, tempodeDica, 0, $("#target1")),
        new Array($("#img2"), 30, 210, 95, 95, 0, tipodeDica, tempodeDica, 0, $("#target2")),
        new Array($("#img3"), 30, 332, 95, 95, 0, tipodeDica, tempodeDica, 0, $("#target3")),
        new Array($("#img4"), 190, 210, 80, 80, 0, tipodeDica, tempodeDica, 0, $("#target4")),
        new Array($("#img5"), 30, 450, 270, 130, 0, tipodeDica, tempodeDica, 0, $("#target5"))
    );
...
//imagem 5
    ...
    function mostraDicaPisca(i){
        ...
        if(vet[i][9].offset().top > 550) //seria pras três maças
        {
        ...
        if(vet[i][9].offset().top > 400 && vet[i][9].offset().top < 500)
        {
            $("#dicaPisca2").fadeIn(500);
            $("#dicaPisca2").fadeOut(500);
        }
        if(vet[i][9].offset().top < 300)
        {
            $("#dicaPisca3").fadeIn(500);
            $("#dicaPisca3").fadeOut(500);
        }
        if(vet[i][9].offset().top > 300 && vet[i][9].offset().top < 400)
        {
    ...
    function ajaxSave() {
        ...
        var idAtividade = 8;    //alterar esse id para o número do jogo
