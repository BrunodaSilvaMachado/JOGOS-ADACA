...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img1"), 33, 330, 60, 60, 0, tipodeDica, tempodeDica, 0, $("#target1")),
        new Array($("#img2"), 150, 330, 60, 60, 0, tipodeDica, tempodeDica, 0, $("#target2")),
        new Array($("#img3"), 270, 330, 60, 60, 0, tipodeDica, tempodeDica, 0, $("#target3")),
        new Array($("#img4"), 120, 450, 85, 50, 0, tipodeDica, tempodeDica, 0, $("#target4")),
        new Array($("#img5"), 100, 550, 120, 135, 0, tipodeDica, tempodeDica, 0, $("#target5")),
        new Array($("#img6"), 30, 12, 345, 275, 0, tipodeDica, tempodeDica, 0, $("#target6"))
    );
...
//FadeIn e FadeOut das imagens
    $("#dicaPisca1_1").fadeOut(0);
    $("#dicaPisca1_2").fadeOut(0);
    $("#dicaPisca1_3").fadeOut(0);
        ...
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                dicaTimeout = setTimeout(function() {
                    ...
                    {
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left -100), (vet[i][9].offset().top))
                    }else if(target2Ocupado == false)
                    {
                        mostraDica(i, vet[i][6], (vet[i+1][9].offset().left - 100), (vet[i+1][9].offset().top))
                    }else
                    {
                        mostraDica(i, vet[i][6], (vet[i+2][9].offset().left - 100), (vet[i+2][9].offset().top))
                    }
                }, vet[i][7]);
            }
        },
    ...
    vet[3][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 90), (vet[i][9].offset().top - 20))
                }, vet[i][7]);
            }
        },
        stop: function() {
    ...
    vet[4][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top + 20))
                }, vet[i][7]);
            }
        },
        stop: function() {
    ...
    vet[5][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top + 30))
                }, vet[i][7]);
            }
        },
        stop: function() {
...
//imagem 6
    ...
    function mostraDicaPisca(i){
        if(i == 0){
            $("#dicaPisca1_1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca1_2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
            $("#dicaPisca1_3").css({left: vet[i+2][9].offset().left, top: vet[i+2][9].offset().top});
        }
        if(i==1)
        {
            $("#dicaPisca1_1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca1_2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca1_3").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
        }
        if(i==2)
        {
            $("#dicaPisca1_1").css({left: vet[i-2][9].offset().left, top: vet[i-2][9].offset().top});
            $("#dicaPisca1_2").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca1_3").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
        }
        ...
        if(vet[i][9].offset().top > 570) //seria pras três maças
        {
            $("#dicaPisca1_1").fadeIn(500);
            $("#dicaPisca1_1").fadeOut(500);
            $("#dicaPisca1_2").fadeIn(500);
            $("#dicaPisca1_2").fadeOut(500);
            $("#dicaPisca1_3").fadeIn(500);
            $("#dicaPisca1_3").fadeOut(500);
        }
        if(vet[i][9].offset().top > 450 && vet[i][9].offset().top < 500)
        {
            $("#dicaPisca2").fadeIn(500);
            $("#dicaPisca2").fadeOut(500);
        }
        if(vet[i][9].offset().top > 440 && vet[i][9].offset().top < 450)
        {
            $("#dicaPisca3").fadeIn(500);
            $("#dicaPisca3").fadeOut(500);
        }
        if(vet[i][9].offset().top < 306)
        {
    ...
    function ajaxSave() {
        ...
        var idAtividade = 9;    //alterar esse id para o número do jogo
