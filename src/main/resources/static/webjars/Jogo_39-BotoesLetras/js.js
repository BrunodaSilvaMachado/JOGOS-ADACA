...
//imagem 9
    ...
    function endgame() {
        if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && vet[3][5] == 2 && vet[4][5] == 2 && vet[5][5] == 2 && vet[6][5] == 2 && vet[7][5] == 2 && vet[8][5] == 2) {           // Se as três imagens já estiverem nos alvos, dipara
            finalizado = 1;
            for(i=0; i<numObjtos; i++){
                vet[i][0].fadeOut(200);
                vet[i][9].fadeOut(200);
    ...
    function ajaxSave() {
        ...
        var idAtividade = 39;    //alterar esse id para o número do jogo
