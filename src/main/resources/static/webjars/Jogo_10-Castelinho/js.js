...
while( sort2 == sort1 || sort3 == sort1 || sort3 == sort2) {
       sort2 = rand(1,3);
       sort3= rand(1,3);
 };
...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img1"), 113, 12, 110, 110, 0, tipodeDica, tempodeDica, 0, $("#target1")),
        new Array($("#img2"), 113, 202, 110, 110, 0, tipodeDica, tempodeDica, 0, $("#target2")),
        new Array($("#img3"), 110, 330, 40, 40, 0, tipodeDica, tempodeDica, 0, $("#target3")),
        new Array($("#img4"), 180, 330, 40, 40, 0, tipodeDica, tempodeDica, 0, $("#target4")),
        new Array($("#img5"), 30, 12, 75, 300, 0, tipodeDica, tempodeDica, 0, $("#target5")),
        new Array($("#img6"), 230, 12, 75, 300, 0, tipodeDica, tempodeDica, 0, $("#target6")),
        new Array($("#img7"), 110, 380, 110, 95, 0, tipodeDica, tempodeDica, 0, $("#target7")),
        new Array($("#img8"), 30, 500, 290, 200, 0, tipodeDica, tempodeDica, 0, $("#target8"))
    );

    
    var numObjtos = 8; //quantidade de figuras
...
//Criação de Variáveis
    ...
    var target1Ocupado_tri = false;  // Para testar se existe uma imagem no local que está querendo colocar
    var target2Ocupado_tri = false;
    var target1Ocupado_quad = false;
    var target2Ocupado_quad = false;
    var target1Ocupado_torre = false;
    var target2Ocupado_torre = false;
...
//FadeIn e FadeOut das imagens
    $("#dicaPisca1_tri1").fadeOut(0);
    $("#dicaPisca1_tri2").fadeOut(0);
    $("#dicaPisca2_quad1").fadeOut(0);
    $("#dicaPisca2_quad2").fadeOut(0);
    $("#dicaPisca3_torre1").fadeOut(0);
    $("#dicaPisca3_torre2").fadeOut(0);
    $("#dicaPisca4").fadeOut(0);
    $("#dicaPisca5").fadeOut(0);
    var i;
    ...
    vet[0][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                vet[7][0].css({zIndex: 0});
                cliqueCerto++;
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    if(target1Ocupado_tri == false)
                    {
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left - 60), (vet[i][9].offset().top))
                    }else
                    {
                        mostraDica(i, vet[i][6], (vet[i+1][9].offset().left - 60), (vet[i+1][9].offset().top))
                    }
                }, vet[i][7]);
            }
        },
        stop: function() {
            ...
            {
                if(target1Ocupado_tri == false)                                         //Testa se o local que ela vai ocupar, já tem uma imagem lá. 
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top, zIndex: 1}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;    // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');    // e desabilita o drag dela
                    target1Ocupado_tri = true;
                    cliqueCerto++;
                    endgame();
                }
                else 
            ...
            {
                if(target2Ocupado_tri == false)
                {
                    vet[i][0].css({left: vet[i+1][9].position().left, top: vet[i+1][9].position().top, zIndex: 1}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela   
                    target2Ocupado_tri = true;
                    cliqueCerto++;
                    endgame();
                }
                else 
    ...
    vet[2][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    if(target1Ocupado_quad == false)
                    {
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left - 80), (vet[i][9].offset().top - 20))
                    }else
                    {
                        mostraDica(i, vet[i][6], (vet[i+1][9].offset().left - 80), (vet[i+1][9].offset().top - 20))
                    }
                }, vet[i][7]);
            }
        },
        stop: function() {
            ...
            if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4]))
            {
                if(target1Ocupado_quad == false)                                         //Testa se o local que ela vai ocupar, já tem uma imagem lá. 
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top, zIndex: 1}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela
                    target1Ocupado_quad = true;
                    cliqueCerto++;
                    endgame();
                }
                else 
            ...
            if (mousex > vet[i+1][9].offset().left && mousex < (vet[i+1][9].offset().left + vet[i][3]) && mousey > vet[i+1][9].offset().top && mousey < (vet[i+1][9].offset().top + vet[i][4])) 
            {
                if(target2Ocupado_quad == false)
                {
                    vet[i][0].css({left: vet[i+1][9].position().left, top: vet[i+1][9].position().top, zIndex: 1}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela   
                    target2Ocupado_quad = true;
                    cliqueCerto++;
                    endgame();
                }
                else 
    ...
    vet[4][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    if(target1Ocupado_torre == false)
                    {
                        mostraDica(i, vet[i][6], (vet[i][9].offset().left - 80), (vet[i][9].offset().top + 100))
                    }else
                    {
                        mostraDica(i, vet[i][6], (vet[i+1][9].offset().left - 80), (vet[i+1][9].offset().top + 100))
                    }
                }, vet[i][7]);
            }
        },
        stop: function() {
            ...
            if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4]))
            {
                if(target1Ocupado_torre == false)                                         //Testa se o local que ela vai ocupar, já tem uma imagem lá. 
                {                                                                       //Se tiver, ela não pode se sobrepor
                    vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top, zIndex: 1}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela
                    target1Ocupado_torre = true;
                    cliqueCerto++;
                    endgame();
                }
                else 
            ...
            if (mousex > vet[i+1][9].offset().left && mousex < (vet[i+1][9].offset().left + vet[i][3]) && mousey > vet[i+1][9].offset().top && mousey < (vet[i+1][9].offset().top + vet[i][4])) 
            {
                if(target2Ocupado_torre == false)
                {
                    vet[i][0].css({left: vet[i+1][9].position().left, top: vet[i+1][9].position().top, zIndex: 1}); // Em cima, o if testa se o mouse está dentro dos limites do alvo
                    vet[i][5] = 2;                                                             // se sim, coloca a imagem sobre o alvo, muda o state dela para 2
                    vet[i][0].draggable('disable');                                              // e desabilita o drag dela   
                    target2Ocupado_torre = true;
                    cliqueCerto++;
                    endgame();
                }
                else 
    ...
    vet[6][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 70), (vet[i][9].offset().top))
                }, vet[i][7]);
            }
        },
        stop: function() {
            ...
            if (mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
				$("#container").append(vet[i][0]);
					vet[i][0].css({left: vet[i][9].position().left, top: vet[i][9].position().top, zIndex: 1});
                vet[i][5] = 2;
    ...
    vet[7][0].draggable({
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                mouseDrag += "("+mousex+","+mousey+";";
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 60), (vet[i][9].offset().top + 30))
                }, vet[i][7]);
            }
        },
        stop: function() {
    ...
    vet[0][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
                ...
                vet[i][0].css({left: vet[i][1], top: vet[i][2], zIndex: 1});
                vet[i][5] = 0;
    ...
    vet[4][0].click(function() {
        ...
        if (vet[i][5] == 0){
            ...
            dicaTimeout = setTimeout(function() {
                if(target1Ocupado_torre == false)
                {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 80), (vet[i][9].offset().top))
                }else
                {
                    mostraDica(i, vet[i][6], (vet[i+1][9].offset().left - 80), (vet[i+1][9].offset().top))
                }
            }, vet[i][7]);
        } else if (vet[i][5] == 1) {
            if (mousex > vet[i][1] && mousex < (vet[i][1]+vet[i][3]) && mousey > vet[i][2] && mousey < (vet[i][2]+vet[i][4])) {
...
//imagem 8
    ...
    function mostraDicaPisca(i){
        if(i==0)
        {
            $("#dicaPisca1_tri1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca1_tri2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
        }
        if(i==1)
        {
            $("#dicaPisca1_tri1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca1_tri2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
        }

        if(i==2)
        {
            $("#dicaPisca2_quad1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca2_quad2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
        }
        if(i==3)
        {
            $("#dicaPisca2_quad1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca2_quad2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
        }

        if(i==4)
        {
            $("#dicaPisca3_torre1").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
            $("#dicaPisca3_torre2").css({left: vet[i+1][9].offset().left, top: vet[i+1][9].offset().top});
        }
        if(i==5)
        {
            $("#dicaPisca3_torre1").css({left: vet[i-1][9].offset().left, top: vet[i-1][9].offset().top});
            $("#dicaPisca3_torre2").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
        }
        ...
        if(vet[i][9].offset().top < 160)
        {
            $("#dicaPisca1_tri1").fadeIn(500);
            $("#dicaPisca1_tri1").fadeOut(500);
            $("#dicaPisca1_tri2").fadeIn(500);
            $("#dicaPisca1_tri2").fadeOut(500);
        }
        if(vet[i][9].offset().top > 280 && vet[i][9].offset().top < 300)
        {
            $("#dicaPisca2_quad1").fadeIn(500);
            $("#dicaPisca2_quad1").fadeOut(500);
            $("#dicaPisca2_quad2").fadeIn(500);
            $("#dicaPisca2_quad2").fadeOut(500);
        }
        if(vet[i][9].offset().top > 260 && vet[i][9].offset().top < 270)
        {
            $("#dicaPisca3_torre1").fadeIn(500);
            $("#dicaPisca3_torre1").fadeOut(500);
            $("#dicaPisca3_torre2").fadeIn(500);
            $("#dicaPisca3_torre2").fadeOut(500);
        }
        if(vet[i][9].offset().top > 400)
        {
            $("#dicaPisca4").fadeIn(500);
            $("#dicaPisca4").fadeOut(500);
        }
        if(vet[i][9].offset().top > 350 && vet[i][9].offset().top < 370)
        {
    ...
    function endgame() {
        if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && vet[3][5] == 2 && vet[4][5] == 2 && vet[5][5] == 2 && vet[6][5] == 2 && vet[7][5] == 2) {           // Se as três imagens já estiverem nos alvos, dipara
            finalizado = 1;
            for(i=0; i<numObjtos; i++){
                vet[i][0].fadeOut(200);
                vet[i][9].fadeOut(200);
    ...
    function ajaxSave() {
        ...
        var idAtividade = 10;    //alterar esse id para o número do jogo
