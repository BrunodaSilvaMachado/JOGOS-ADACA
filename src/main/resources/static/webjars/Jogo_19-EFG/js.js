...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 65, 111, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 65, 291, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 65, 473, 160, 160, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );    
...
//imagem 3
    ...
    function mostraDicaPisca(i){
        ...
        if(vet[i][9].offset().top > 115 && vet[i][9].offset().top < 450)
        {
    ...
    function ajaxSave() {
        ...
        var idAtividade = 19;    //alterar esse id para o número do jogo
