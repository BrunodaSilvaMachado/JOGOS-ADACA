...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 65, 111, 105, 105, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 65, 291, 105, 105, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 65, 473, 105, 105, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
    ...
    var numObjtos = 3; //quantidade de figura
        ...
        start: function() {
            ...
            if (vet[i][5] == 0){
                ...
                dicaTimeout = setTimeout(function() {
                    mostraDica(i, vet[i][6], (vet[i][9].offset().left - 100), (vet[i][9].offset().top + 15))
                }, vet[i][7]);
            }
        },
        stop: function() {
...
//imagem 3
    ...
    function mostraDicaPisca(i){
        ...
        if(vet[i][9].offset().left < 400)
        {
            $("#dicaPisca2").fadeIn(500);
            $("#dicaPisca2").fadeOut(500);
        }
        if(vet[i][9].offset().left > 400 && vet[i][9].offset().top < 600)
        {
            $("#dicaPisca1").fadeIn(500);
            $("#dicaPisca1").fadeOut(500);
        }
        if(vet[i][9].offset().left > 600)
        {
    ...
    var idTutor = 1             // só para teste tbm. Tem que alterar dps.
     ...
     function ajaxSave() {
        ...
        var idAtividade = 17;    //alterar esse id para o número do jogo
