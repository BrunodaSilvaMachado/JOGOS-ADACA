...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img1"), 15, 70, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target1")),     //NÃO PODE TER DIA, SENÃO BUGA
        new Array($("#img2"), 175, 70, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target2")),  //NÃO PODE TER DIA, SENÃO BUGA
        new Array($("#img3"), 335, 70, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target3")),  //NÃO PODE TER DIA, SENÃO BUGA
        new Array($("#img4"), 495, 70, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target4")),
        new Array($("#img5"), 655, 70, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target5"))    //NÃO PODE TER DIA, SENÃO BUGA
    );
...
function animaEstrela(){
    ...
    function ajaxSave() {
        ...
        var idAtividade = 53;    //alterar esse id para o número do jogo
