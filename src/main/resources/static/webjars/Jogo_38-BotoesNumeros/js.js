...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+1), 20, 20, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+1)),
        new Array($("#img"+2), 150, 20, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#img"+3), 280, 20, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#img"+4), 20, 310, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#img"+5), 150, 310, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+5)),
        new Array($("#img"+6), 280, 310, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+6)),
        new Array($("#img"+7), 20, 600, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+7)),
        new Array($("#img"+8), 150, 600, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+8)),
        new Array($("#img"+9), 280, 600, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+9))
    );

    var numObjtos = 9; //quantidade de figuras
...
//imagem 9
    ...
    function endgame() {
        if (vet[0][5] == 2 && vet[1][5] == 2 && vet[2][5] == 2 && vet[3][5] == 2 && vet[4][5] == 2 && vet[5][5] == 2 && vet[6][5] == 2 && vet[7][5] == 2 && vet[8][5]== 2) {           // Se todas as imagens já estiverem nos alvos, dipara
            finalizado = 1;
            for(i=0; i<numObjtos; i++){
                vet[i][0].fadeOut(200);
                vet[i][9].fadeOut(200);
    ...
    var nomeAutista            // will vai passar o nome. Exibiremos na tela.
    var idAutista = 1          //onde é 1, é só pra testar. Futuramente, alterar para as variáveis que recebermos.
    var nomeAtividade          // Apenas para exibir na tela se precisar.
    var idAtividade = 1         // teste por enquanto tbm. Temos que alterar para o id correto dps.
    var nomeTutor              // só para exibir em algum lugar se precisar
    var idTutor = 1             // só para teste tbm. Tem que alterar dps.
    ...
    function ajaxSave() {
        ...
        var idAtividade = 38;    //alterar esse id para o número do jogo
