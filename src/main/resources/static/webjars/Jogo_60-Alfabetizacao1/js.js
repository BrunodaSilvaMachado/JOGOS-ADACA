...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#"+animal[0]), 10, 200, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+1)),
        new Array($("#"+animal[1]), 120, 200, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#"+animal[2]), 230, 200, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#"+animal[3]), 340, 200, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#"+letras[0]), 10, 400, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+5)),
        new Array($("#"+letras[1]), 120, 400, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+6)),
        new Array($("#"+letras[2]), 230, 400, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+7)),
        new Array($("#"+letras[3]), 340, 400, 100, 100, 0, tipodeDica, tempodeDica, 0, $("#target"+8))
    );
