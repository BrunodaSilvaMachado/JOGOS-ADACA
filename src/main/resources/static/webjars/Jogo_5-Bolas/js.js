...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 65, 82, 200, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 65, 275, 200, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2)),
        new Array($("#img"+sort3), 65, 470, 200, 200, 0, tipodeDica, tempodeDica, 0, $("#target"+sort3))
    );
...
console.log(new Date())
    ...
    function ajaxSave() {
        ...
        var idAtividade = 5;    //alterar esse id para o número do jogo
