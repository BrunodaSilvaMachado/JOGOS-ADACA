 urlGlobal = window.location.search.substring(1);
...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img1"), 150, 12, 65, 65, 0, tipodeDica, tempodeDica, 0, $("#target1")),
        new Array($("#img2"), 150, 140, 65, 65, 0, tipodeDica, tempodeDica, 0, $("#target2")),
        new Array($("#img3"), 150, 268, 65, 65, 0, tipodeDica, tempodeDica, 0, $("#target3")),
        new Array($("#img4"), 30, 12, 90, 330, 0, tipodeDica, tempodeDica, 0, $("#target4")),
        new Array($("#img5"), 30, 350, 355, 355, 0, tipodeDica, tempodeDica, 0, $("#target5"))
    );
...
//imagem 5
    ...
    function mostraDicaPisca(i){
        ...
        if(vet[i][9].offset().top > 15 && vet[i][9].offset().top < 250) //seria pras três maças
        {
        ...
        if(vet[i][9].offset().top > 300 && vet[i][9].offset().top < 370)
        {
            $("#dicaPisca2").fadeIn(500);
            $("#dicaPisca2").fadeOut(500);
        }
        if(vet[i][9].offset().top < 15)
        {
    ...
    function ajaxSave() {
        ...
        var idAtividade = 7;    //alterar esse id para o número do jogo
