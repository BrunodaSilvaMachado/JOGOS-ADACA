...
$(document).ready(function() {
   ...
   function rand(num_minimo,num_maximo) {
    ...
    var numTotal = 5;        //num de imagens/targets totais
...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sortido[0]), 20, 50, 127, 126, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[0])),
        new Array($("#img"+sortido[1]), 110, 270, 127, 126, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[1])),
        new Array($("#img"+sortido[2]), 20, 490, 127, 126, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[2])),
        new Array($("#img"+sortido[3]), 210, 50, 127, 126, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[3])),
        new Array($("#img"+sortido[4]), 210, 490, 127, 126, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[4]))
    );
    
        //reposicionamento
    vet[0][0].css({left: 20, top: 50});
    vet[1][0].css({left: 110, top: 270});
    vet[2][0].css({left: 20, top: 490});
    vet[3][0].css({left: 210, top: 50});
    vet[4][0].css({left: 210, top: 490});
...
//imagem 5
    ...
    function ajaxSave() {
        ...
        var idAtividade = 58;    //alterar esse id para o número do jogo
