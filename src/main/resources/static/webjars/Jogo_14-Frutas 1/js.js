...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sort1), 30, 85, 220, 220, 0, tipodeDica, tempodeDica, 0, $("#target"+sort1)),
        new Array($("#img"+sort2), 30, 380, 220, 220, 0, tipodeDica, tempodeDica, 0, $("#target"+sort2))
...
if (sort1 == 2) {
    ...
    var numObjtos = 2; //quantidade de figuras
...
//imagem 2
    ...
    function endgame() {
        if (vet[0][5] == 2 && vet[1][5] == 2) {            // Se as três imagens já estiverem nos alvos, dipara
            finalizado =1 ;
            vet[0][0].fadeOut(200);                                    // Some as três
            vet[1][0].fadeOut(200);                                    // imagens com
                                                        // fadeOut
            for(i=0; i<numObjtos; i++){
                vet[i][0].fadeOut(200);
                vet[i][9].fadeOut(200);
    ...
    function ajaxSave() {
        ...
        var idAtividade = 14;    //alterar esse id para o número do jogo
