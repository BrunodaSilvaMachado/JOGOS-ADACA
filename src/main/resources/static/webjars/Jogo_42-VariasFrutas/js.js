...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+sortido[0]), 70, 24, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[0])),
        new Array($("#img"+sortido[1]), 70, 198, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[1])),
        new Array($("#img"+sortido[2]), 70, 372, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[2])),
        new Array($("#img"+sortido[3]), 70, 546, 150, 150, 0, tipodeDica, tempodeDica, 0, $("#target"+sortido[3]))
...
//imagem 4
    ...
    function mostraDicaPisca(i){
        $("#dicaPisca").css({left: vet[i][9].offset().left, top: vet[i][9].offset().top});
        ...
        if(vet[i][9].offset().top < 100)
        {
            $("#dicaPisca1").fadeIn(500);
            $("#dicaPisca1").fadeOut(500);
        }
        
        if(vet[i][9].offset().top < 200 && vet[i][9].offset().top > 100)
        {
             $("#dicaPisca2").fadeIn(500);
             $("#dicaPisca2").fadeOut(500);
        }
        if(vet[i][9].offset().top < 400 && vet[i][9].offset().top > 300)
        {
    ...
    function mostraDica(i, td, x, y){
        ...
        if(td == "Seta"){
            ...
            dica.fadeIn(500);
            dicaInterval = setInterval(animaDica, 1510);
        }else{
            //vet[i][0].css({left: x, top: y, zIndex: 2});
            //mostraDicaPisca(i);
            dicaInterval = setInterval( function() {mostraDicaPisca(i);}, 1510);
        }
        quantDicasUsadas++;
    }
    ...
    function salvaDados(){
        var jogador;
        //aqui estamos pegando o nome de Usuario e a Senha da Criança lá do arquivo login.
    ...
    function ajaxSave() {
        ...
        var idAtividade = 42;    //alterar esse id para o número do jogo
