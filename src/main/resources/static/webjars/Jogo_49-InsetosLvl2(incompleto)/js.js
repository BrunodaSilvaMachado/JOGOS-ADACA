...
//  [ID][0-imagem, 1-Xinicial, 2-Yinicial, 3-larguraX, 4-larguraY,
    ...
    vet = new Array(
        new Array($("#img"+1), 191, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+1)),
        new Array($("#img"+2), 352, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+2)),
        new Array($("#img"+3), 511, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+3)),
        new Array($("#img"+4), 352, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+4)),
        new Array($("#img"+5), 511, 481, 130, 130, 0, tipodeDica, tempodeDica, 0, $("#target"+5))
    );
...
//imagem 1
    vet[0][0].draggable({
        ...
        stop: function() {
            i=0;
            if (vet[1][5]==2 && mousex > vet[i][9].offset().left && mousex < (vet[i][9].offset().left + vet[i][3]) && mousey > vet[i][9].offset().top && mousey < (vet[i][9].offset().top + vet[i][4])){
...
//imagem 3
    ...
    function endgame() {
        if (vet[0][5] == 2 && vet[1][5] == 2) {           // Se as três imagens já estiverem nos alvos, dipara
            for(i=0; i<numObjtos; i++){
                vet[i][0].fadeOut(200);
                vet[i][9].fadeOut(200);
            }
    ...
    function ajaxSave() {
        ...
        var idAtividade = 49;    //alterar esse id para o número do jogo
